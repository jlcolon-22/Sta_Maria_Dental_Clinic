        ...
        <section x-data="main"
            ...
            <div class="bg-white shadow-md rounded-md mt-7  p-5  overflow-hidden">
                ...
                <div class="mt-5 py-2 flex items-center justify-between gap-2">
                    <button class="py-2 px-4 h-fit bg-ylw text-white rounded hidden sm:block" x-on:click="toggle">Add Doctor</button>
                    <button class="py-2 px-4 h-fit bg-ylw text-white rounded block sm:hidden" x-on:click="toggle">Add</button>
