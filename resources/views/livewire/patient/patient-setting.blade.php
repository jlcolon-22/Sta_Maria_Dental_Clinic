<div x-data='mainData' x-show="setting"  class="fixed bg-black/50 z-50 top-0 left-0 w-full max-h-[100svh] text-primary overflow-y-scroll ">
    <div  x-show="setting"  class="bg-white max-w-[35rem] mx-auto pb-20 pt-10 rounded shadow-md my-10 relative" x-transition>
        ...
        <form  wire:submit.prevent='updatePatient' class="space-y-4 px-10 pt-10" autocomplete="off">
            ...
            <div class="grid">
                <button class="bg-btnDark  text-white py-2 mt-2">Update</button>
            </div>
